...
static const char *fonts[]          = { "Jetbrains Mono NerdFont:size=16:style=Bold", "monospace:size=16" };
static const char dmenufont[]       = "Jetbrains Mono NerdFont:size=14:style=Bold";
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_e,                  spawn,          SHCMD("yazi") },                              // open file manager (nemo) MOD+e
	{ MODKEY,                       XK_c,                  spawn,          SHCMD("phpstorm") },                              // open file manager (nemo) MOD+e
	...
	{ MODKEY,                       XK_a,                  incnmaster,     {.i = -1 } },                                      // decrease windows in master stack MOD+d
